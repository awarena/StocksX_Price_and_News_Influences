...
LAST_UPDATE_FILE = "E:\Projects\StocksX_Price_and_News_Influences\Raw_Data/last_update.txt"
STOCKS_DIR = "E:\Projects\StocksX_Price_and_News_Influences\Raw_Data/stocks"
ETFS_DIR = "E:\Projects\StocksX_Price_and_News_Influences\Raw_Data/etfs"
METADATA_FILE = "E:\Projects\StocksX_Price_and_News_Influences\Raw_Data/symbols_valid_meta.csv"
...
def fetch_data(symbol, directory, attempt=1, backoff=0):
    ...
    period = "max" if not os.path.exists(csv_path) else f"{days_since_last_update()}d"
